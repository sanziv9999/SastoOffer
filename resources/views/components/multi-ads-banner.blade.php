                ...
                @foreach($categories as $index => $category)
                    ...
                    <div class="flex-shrink-0 w-[180px] sm:w-[220px] md:w-[240px]">
                        <a 
                            ...
                            class="group relative block overflow-hidden rounded-xl aspect-[4/5] hover:scale-[1.03] transition-all duration-300 shadow-sm hover:shadow-xl border border-border/10 bg-muted/20"
                        >
