        ...
        >
            <div class="grid grid-cols-[auto_1fr_auto] items-center gap-3">
                <div class="hidden md:flex justify-start">
                    <button 
                        @click="scrollLeft()"
                        class="h-10 w-10 flex items-center justify-center bg-white shadow-xl rounded-full border border-border/50 text-foreground hover:bg-primary hover:text-white transition-all opacity-0 md:group-hover/discover-slider:opacity-100"
