    ...
    <div class="container mx-auto px-4">
        ...
        <div class="group">
            <div class="relative">
                ...
                <button 
                    @click="scrollLeft()"
                    class="hidden md:flex absolute left-3 top-1/2 -translate-y-1/2 h-10 w-10 rounded-full bg-background/90 border border-border shadow opacity-0 md:group-hover:opacity-100 transition-all items-center justify-center text-foreground hover:bg-primary hover:text-white z-20"
                ...
                <button 
                    @click="scrollRight()"
                    class="hidden md:flex absolute right-3 top-1/2 -translate-y-1/2 h-10 w-10 rounded-full bg-background/90 border border-border shadow opacity-0 md:group-hover:opacity-100 transition-all items-center justify-center text-foreground hover:bg-primary hover:text-white z-20"
