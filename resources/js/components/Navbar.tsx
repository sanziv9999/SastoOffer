  ...
  return (
    <header className="bg-background shadow-sm">
      <div className="container mx-auto px-4">
        ...
        <div className="relative group overflow-hidden py-2 max-h-20 opacity-100">
          <div ref={menuScrollRef} className="overflow-x-auto scrollbar-none scroll-smooth" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            <MainNavigation />
          </div>
