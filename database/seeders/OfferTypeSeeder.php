    ...
    public function run(): void
    {
        $offerTypes = [
            ...
            [
                ...
                'calculation_rule' => json_encode([
                    'type'               => 'fixed',
                    'formula_final_price' => 'original_price - discount_amount',
            ...
            [
                ...
                'calculation_rule' => json_encode([
                    'type'               => 'bogo',
                    'formula_final_price' => '(original_price * buy_quantity + original_price * get_quantity * (1 - get_discount_percent/100)) / (buy_quantity + get_quantity)',
            ...
            [
                ...
                'calculation_rule' => json_encode([
                    'type'               => 'free_shipping',
                    'formula_final_price' => 'original_price',
                    'formula'            => 'final_price = original_price',
            ...
            [
                ...
                'default_values'  => json_encode(['cashback_amount' => 0, 'cashback_percent' => 5]),
                'is_active'       => true,
            ],
        ];
